...
public abstract class GameFragmentBinding extends ViewDataBinding {
  ...
  @Bindable
  protected GameViewModel mGameViemModel;

  protected GameFragmentBinding(Object _bindingComponent, View _root, int _localFieldCount,
      Button correctButton, ConstraintLayout gameLayout, Guideline guideline, TextView scoreText,
      Button skipButton, TextView timerText, TextView wordIsText, TextView wordText) {
  ...
  public abstract void setGameViemModel(@Nullable GameViewModel gameViemModel);

  @Nullable
  public GameViewModel getGameViemModel() {
    return mGameViemModel;
  }
