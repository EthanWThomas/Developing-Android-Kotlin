...
public class GameFragmentBindingImpl extends GameFragmentBinding implements com.example.android.guesstheword.generated.callback.OnClickListener.Listener {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeGameViemModelCurretTimeString((androidx.lifecycle.LiveData<java.lang.String>) object, fieldId);
            case 1 :
    ...
    private boolean onChangeGameViemModelCurretTimeString(androidx.lifecycle.LiveData<java.lang.String> GameViemModelCurretTimeString, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        androidx.lifecycle.LiveData<java.lang.String> gameViemModelCurretTimeString = null;
        java.lang.String gameViemModelCurretTimeStringGetValue = null;
        ...
        if ((dirtyFlags & 0x1fL) != 0) {
            ...
            if ((dirtyFlags & 0x19L) != 0) {
                    ...
                    if (gameViemModel != null) {
                        // read gameViemModel.curretTimeString
                        gameViemModelCurretTimeString = gameViemModel.getCurretTimeString();
                    }
                    updateLiveDataRegistration(0, gameViemModelCurretTimeString);


                    if (gameViemModelCurretTimeString != null) {
                        // read gameViemModel.curretTimeString.getValue()
                        gameViemModelCurretTimeStringGetValue = gameViemModelCurretTimeString.getValue();
                    }
            }
            if ((dirtyFlags & 0x1aL) != 0) {
                    ...
                    updateLiveDataRegistration(1, gameViemModelWord);
            ...
            if ((dirtyFlags & 0x1cL) != 0) {
                    ...
                    updateLiveDataRegistration(2, gameViemModelScore);
        ...
        if ((dirtyFlags & 0x19L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.timerText, gameViemModelCurretTimeStringGetValue);
        }
        if ((dirtyFlags & 0x1aL) != 0) {
            // api target 1
    ...
    /* flag mapping
        flag 0 (0x1L): gameViemModel.curretTimeString
        flag 1 (0x2L): gameViemModel.word
        flag 2 (0x3L): gameViemModel.score
        flag 3 (0x4L): gameViemModel
        flag 4 (0x5L): null
    flag mapping end*/
    //end
}