...
public class GameWonFragmentArgs implements NavArgs {
  ...
  public static GameWonFragmentArgs fromBundle(@NonNull Bundle bundle) {
    ...
    if (bundle.containsKey("numQuestion")) {
      int numQuestion;
      numQuestion = bundle.getInt("numQuestion");
      __result.arguments.put("numQuestion", numQuestion);
    } else {
      throw new IllegalArgumentException("Required argument \"numQuestion\" is missing and does not have an android:defaultValue");
    }
  ...
  public static class Builder {
    ...
    public Builder(int numQuestion, int numCorrect) {
    ...
    @NonNull
    public Builder setNumQuestion(int numQuestion) {
      this.arguments.put("numQuestion", numQuestion);
      return this;
    }
