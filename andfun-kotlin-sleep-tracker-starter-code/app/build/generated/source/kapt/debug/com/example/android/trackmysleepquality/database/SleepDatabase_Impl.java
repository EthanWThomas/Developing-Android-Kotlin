  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `daily_sleep_quality_table` (`night` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `start_time_milli` INTEGER NOT NULL, `end_time_milli` INTEGER NOT NULL, `quality_rating` INTEGER NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '7dbd5f9d7c64a0bcfb436cac433561ef')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsDailySleepQualityTable.put("night", new TableInfo.Column("night", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "7dbd5f9d7c64a0bcfb436cac433561ef", "d35745d5e51f097db972eee5d01e5d31");
