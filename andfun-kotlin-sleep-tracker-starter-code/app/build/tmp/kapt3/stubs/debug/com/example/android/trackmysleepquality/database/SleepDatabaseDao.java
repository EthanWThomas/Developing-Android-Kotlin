...
public abstract interface SleepDatabaseDao {
    ...
    @androidx.room.Query(value = "SELECT * from daily_sleep_quality_table WHERE night = :key")
    ...
    @androidx.room.Query(value = "SELECT * FROM daily_sleep_quality_table ORDER BY night DESC")
    @org.jetbrains.annotations.NotNull
    ...
    @androidx.room.Query(value = "SELECT * FROM daily_sleep_quality_table ORDER BY night DESC LIMIT 1")
